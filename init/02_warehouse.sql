...
CREATE TABLE IF NOT EXISTS dim_user_date (
...
CREATE TABLE IF NOT EXISTS dim_merchant_date (
    date_key              INT PRIMARY KEY,
    date_full             DATE NOT NULL,
    date_day_of_week      INT NOT NULL,
    date_month_num        INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS dim_staff_date (
    date_key              INT PRIMARY KEY,
    date_full             DATE NOT NULL,
    date_day_of_week      INT NOT NULL,
    date_month_num        INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS dim_staff (
    ...
    staff_creation_date_key INT REFERENCES dim_staff_date(date_key)
);
...
CREATE TABLE IF NOT EXISTS dim_user (
    ...
    user_creation_date_key INT REFERENCES dim_user_date(date_key)
    user_birthdate_key     INT REFERENCES dim_date(date_key) 
);
...
-- Fact Tables
CREATE TABLE IF NOT EXISTS fact_promotion_eligibility (
    campaign_key          INT REFERENCES dim_campaign(campaign_key),
    order_key             INT REFERENCES dim_order(order_key),
